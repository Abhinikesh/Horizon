      ...
      <div className="container py-16">
        ...
        <div className="grid lg:grid-cols-5 gap-12 mb-12">
          ...
          {Object.entries(footerLinks).map(([cat, links]) => (
            <div key={cat}>
              <h4 className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-4">{cat}</h4>
        ...
        {/* Newsletter */}
        <div className="border border-gray-200 rounded-lg p-6 mb-10 flex flex-col sm:flex-row items-start sm:items-center gap-5 justify-between bg-gray-50">
          <div>
